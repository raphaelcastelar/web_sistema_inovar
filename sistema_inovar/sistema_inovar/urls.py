...
from empresas.views import EmpresaViewSet, DocumentosConstitutivosViewSet, XMLViewSet, DepartamentoPessoalViewSet, SimplesNacionalViewSet, OutrosViewSet, enviar_email, HistoricoEnviosViewSet, FuncionarioViewSet, UserCompanyAccessViewSet, CurrentUserView
...
router.register(r'user-company-access', UserCompanyAccessViewSet)
