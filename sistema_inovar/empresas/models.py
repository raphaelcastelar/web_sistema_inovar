...
class DocumentosConstitutivos(models.Model):
    ...
    caminho_arquivo = models.FileField(upload_to=documentos_constitutivos_upload_path, null=False, max_length=500)
...
class XML(models.Model):
    ...
    tipo_documento = models.CharField(max_length=40, null=False)
    caminho_arquivo = models.FileField(upload_to=xml_upload_path, null=False, max_length=500)
    mes = models.CharField(max_length=2, null=False)
...
class DepartamentoPessoal(models.Model):
    ...
    cnpj_empresa = models.CharField(max_length=18, null=False)
    tipo_documento = models.CharField(max_length=40, null=False)
    caminho_arquivo = models.FileField(upload_to=departamento_pessoal_upload_path, null=False, max_length=500)
    mes = models.CharField(max_length=2, null=False)
    ano = models.CharField(max_length=4, null=False)
...
class SimplesNacional(models.Model):
    ...
    cnpj_empresa = models.CharField(max_length=18, null=False)
    tipo_documento = models.CharField(max_length=40, null=False)
    caminho_arquivo = models.FileField(upload_to=simples_nacional_upload_path, null=False, max_length=500)
    mes = models.CharField(max_length=2, null=False)
    ano = models.CharField(max_length=4, null=False)
    entregue = models.BooleanField(default=False)
...
class Outros(models.Model):
    ...
    caminho_arquivo = models.FileField(upload_to=outros_upload_path, max_length=500)
...
class ObrigacaoMensal(models.Model):
    ...
    responsavel_envio = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='obrigacoes_enviadas'
    )
...
class UserCompanyAccess(models.Model):
    user = models.ForeignKey(
        ...
        related_name='usercompanyaccess'
    )
