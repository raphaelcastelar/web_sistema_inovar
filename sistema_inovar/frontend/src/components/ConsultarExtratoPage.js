        ...
        <div className="max-w-4xl mx-auto mt-10 bg-gray-800 p-8 rounded-xl shadow-lg animate-fade-in">
            <div className="flex justify-between items-center border-b border-gray-700 pb-4 mb-6">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-teal-600 text-white rounded-md hover:bg-teal-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6 text-center">
                <div className="bg-gray-700 p-4 rounded-lg">
                    ...
                    <p className="text-xl font-semibold text-white break-all">{dasDetails.numeroDocumento || 'N/A'}</p>
                </div>
                <div className="bg-gray-700 p-4 rounded-lg">
                ...
                <div className="bg-green-800 p-4 rounded-lg">
                    ...
                    <p className="text-xl font-semibold text-white">{formatCurrency(dasDetails.valores?.total || 0)}</p>
                </div>
                <div className="bg-gray-700 p-4 rounded-lg">
                    <p className="text-sm text-gray-400">Situação</p>
                    <p className="text-xl font-semibold text-white">{dasDetails.situacao || 'N/A'}</p>
                </div>
            </div>
